...
public interface IMissingNumberService {
	...
	*/	
	Order calculate(ElementsList elementsList);
	...
	*/
	Order calculateSort(List<Integer> elementsList, String sortType) throws MissingNumberException;
	...
	*/
	Order calculateRandom(Integer maxValue);
	...
	*/
	Order calculateFibonacci(Integer value);
	...
	*/
	List<Order> missingNumbers(Integer lastCalculations) throws MissingNumberException;
